...
clf = pd.read_pickle('./Data_Analysis/model_training/dt_model_dnp3_7_classes.pkl')

## list the feature names
feature_names = ['srcport', 'dstport', 'tcp.hdr_len', 'ip.len']
...
with open("te_dnp3_attack_pl_model.py", "w") as entries_file:

    print("from netaddr import IPAddress\n", file=entries_file)

    print("p4 = bfrt.dnp3_attack_classification_pl.pipe\n", file=entries_file)
...
"""
    ...
    print("traffic_filter  = p4.Ingress.traffic_filter", file=entries_file)
    ...
    # Generate entries for attack mitigation table
